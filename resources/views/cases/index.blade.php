                            ...
                            @forelse($cases as $case=>$value)
                                ...
                                <tr class="bg-white border-b  hover:bg-gray-50 ">
                                    ...
                                    @else
                                        <td class="py-4 px-6">
                                            <div class="flex items-center">
                                                <Link slideover href="{{route('cases.report',$value->id)}}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-2 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Create report</Link>
                                            </div>
                                        </td>
                                    @endif
                                    @endrole
